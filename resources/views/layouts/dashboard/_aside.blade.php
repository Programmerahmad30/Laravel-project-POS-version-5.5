...
<div class="wrapper">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="{{asset('dashboard_files/dist/img/user3-128x128.jpg')}}" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="{{asset('dashboard_files/dist/img/user4-128x128.jpg')}}" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <li><a href="{{route('dashboard.welcome')}}"><i class="fa fa-th"></i><span>@lang('site.dashboard')</span></a></li><br>
